...
const Register = () => {
  ...
  return (
    <div className="mt-5 ">
      <div className="mx-auto mt-15 mb-5 w-full max-w-sm p-4 bg-[#435C70] rounded-lg shadow sm:p-6 md:p-8">
        ...
        <form onSubmit={handleCreateUser} className="space-y-2 text-white">
          <div>
            ...
            <input
              ...
              className=" bg-[#54657D] border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
            />
          </div>
          <div>
          ...
          <div className="flex items-start">
            <div className="flex items-start">
              ...
              <a
                href="#"
                className="text-sm text-[#F5A623] hover:underline ml-2"
              >
                Term & Conditions.
              </a>
            </div>
