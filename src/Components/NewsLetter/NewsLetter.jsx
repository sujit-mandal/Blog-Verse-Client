...
const NewsLetter = () => {
  ...
  return (
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 border-4 border-dashed border-[#C5015F]">
      <div className="mx-auto max-w-screen-md sm:text-center">
        <h2 className="mb-4 text-xl md:text-2xl lg:text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
          Subscribe Now !
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
            ...
            <div>
              <button
                type="submit"
                className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-[#C5015F] border-[#C5015F] sm:rounded-none sm:rounded-r-lg hover:bg-[#c50177fe] "
              >
                Subscribe
              </button>
            </div>
